...
version = (findProperty("releaseVersion") as String?) ?: "1.1.0"
...
tasks.test {
    useJUnitPlatform()
    // 转发 soak 控制属性到测试 JVM（常规回归无影响：SoakTest 默认 assumeTrue(false) 跳过）
    systemProperty("soak", System.getProperty("soak", "false"))
    systemProperty("soakMinutes", System.getProperty("soakMinutes", "20"))
    maxHeapSize = "1g"
}
