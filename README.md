...
|-----------------------|---------|-------|---------|--------|---------|---------|
| Loop Arithmetic 1M    | 0.231   | 25.47 | 14.46   | 5.42   | 79.78   | 0.232   |
| Float Arithmetic 1M   | 1.85    | 25.32 | 14.04   | 5.10   | 84.73   | 0.923   |
| String Concat 100K    | 0.782   | 2.68  | 1.97    | 0.945  | 8.43    | 0.098   |
| Array/List Ops 10K    | 0.108   | 0.363 | 0.146   | 0.056  | 1.20    | 0.041   |
| Object/Map Ops 10K    | 0.303   | 1.44  | 0.264   | 0.678  | 1.67    | 0.243   |
| Branch Intensive 100K | 0.082   | 8.76  | 6.19    | 3.68   | 9.97    | 0.061   |
...
- **Array/List Ops 10K：Aria 0.108 ms**。CALL_STATIC 走 hot path：inst.cache 命中后跳过名称切分、`getStaticFunction`、scope/global 兜底；`list.add` 进一步识别为 builtin 直接 `((ListValue)obj).jvmValue().add(arg)`，跳过 ICallable + InvocationData 分配。仅次于 Groovy（带 invokedynamic 缓存）
