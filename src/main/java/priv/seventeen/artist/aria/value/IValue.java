...
public sealed abstract class IValue<T> extends IData permits
    ...
    public double doubleValue() { return numberValue(); }
    public int intValue() { return (int) numberValue(); }
    public long longValue() { return (long) numberValue(); }
    public float floatValue() { return (float) numberValue(); }
